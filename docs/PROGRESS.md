...
**Last updated:** 2026-04-25 after Sprint 10 Phase 10.4 close.
**Active sprint:** Sprint 10 Phase 10.4 CLOSED. Phase 10.5 (accessibility consumers — colorblind shape/pattern, reducedMotion canvas gating, highContrast theme tokens, fontSize root scale, aria-pass on remaining HUD elements) is the natural next.
